...
class ValenceParameterMap:
    ...
    def to(self, device: DeviceType | None = None, precision: Precision | None = None) -> "ValenceParameterMap":
...
class NonbondedParameterMap:
    ...
    def to(self, device: DeviceType | None = None, precision: Precision | None = None) -> "NonbondedParameterMap":
        """Cast this object to the specified device."""
...
class VSiteMap:
    ...
    def to(self, device: DeviceType | None = None, precision: Precision | None = None) -> "VSiteMap":
        """Cast this object to the specified device."""
        return VSiteMap(self.keys, self.key_to_idx, _cast(self.parameter_idxs, device, precision))
...
class TensorConstraints:
    ...
    def to(self, device: DeviceType | None = None, precision: Precision | None = None) -> "TensorConstraints":
        """Cast this object to the specified device."""
...
class TensorTopology:
    ...
    def to(self, device: DeviceType | None = None, precision: Precision | None = None) -> "TensorTopology":
        """Cast this object to the specified device."""
        return TensorTopology(
            ...
            (None if self.constraints is None else self.constraints.to(device, precision)),
            self.residue_idxs,
            self.residue_ids,
            self.chain_ids,
        )
...
class TensorSystem:
    ...
    def n_atoms(self) -> int:
        ...
        return sum(
            topology.n_atoms * n_copies for topology, n_copies in zip(self.topologies, self.n_copies, strict=True)
        )
    ...
    def n_v_sites(self) -> int:
        ...
        return sum(
            topology.n_v_sites * n_copies for topology, n_copies in zip(self.topologies, self.n_copies, strict=True)
        )
    ...
    def to(self, device: DeviceType | None = None, precision: Precision | None = None) -> "TensorSystem":
        """Cast this object to the specified device."""
        return TensorSystem(
...
class TensorPotential:
    ...
    def to(self, device: DeviceType | None = None, precision: Precision | None = None) -> "TensorPotential":
        ...
        return TensorPotential(
            ...
            (None if self.attributes is None else _cast(self.attributes, device, precision)),
            self.attribute_cols,
...
class TensorVSites:
    ...
    def to(self, device: DeviceType | None = None, precision: Precision | None = None) -> "TensorVSites":
        """Cast this object to the specified device."""
        return TensorVSites(
            self.keys,
...
class TensorForceField:
    ...
    def to(self, device: DeviceType | None = None, precision: Precision | None = None) -> "TensorForceField":
        """Cast this object to the specified device."""
