...
from tyff.datasets.phase import PropertyPhase
...
def validate_entry(entry: DataEntry):
    ...
    `PhysicalProperty`. Right now, tyff's `DataEntry` does not define default units
...
class _PureOrMixtureData:
    ...
    def _solvent_mole_fractions_to_moles(solvent_mass, solvent_mole_fractions, solvent_compounds):
        ...
        Parameters
        ----------
        solvent_mass: tyff.unit.Quantity
        ...
        Returns
        -------
        dict of int and tyff.unit.Quantity
