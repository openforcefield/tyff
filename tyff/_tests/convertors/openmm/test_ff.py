...
def test_convert_to_openmm_ffxml(tmp_cwd, with_constraints, smiles):
    ...
    ff, [top] = tyff.converters.convert_interchange(interchange)

    [ffxml] = tyff.converters.openmm._ff.convert_to_openmm_ffxml(ff, top)
    ...
    system_from_xml = omm_ff.createSystem(
        tyff.converters.convert_to_openmm_topology(top),
